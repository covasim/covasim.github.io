...
<div class="col-md-12 ml-auto mr-auto">
  <ul id="icons-links" class="text-center" style="margin-top:0px; list-style: none; padding: 0;">
    <li style="display:inline; margin: 5px;">
      <a href="https://docs.idmod.org/projects/covasim/en/latest/" target="_blank">
    ...
    <li style="display:inline; margin: 5px;">
      <a href="https://docs.idmod.org/projects/covasim/en/latest/tutorials.html" target="_blank">
        <button class="btn btn-primary">
